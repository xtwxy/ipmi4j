...
public class UnknownResponseTest {
	...
	private static final byte[] WIRE = {
			...
			0x6d, 0x17, 0x2a, 0x40, 0x4b, 0x07, 0x20, (byte)0xb4, 
			0x2c, (byte)0x81, 0x0c, 0x3e, 0x35
		};
	...
	public void testToWireData() throws Exception {
		...
		UnknownIpmiResponse response = new UnknownIpmiResponse(IpmiCommandName.GroupExtensionUnassigned);
	...
	public void testFromWireData() {
        ...
        UnknownIpmiResponse response = (UnknownIpmiResponse) session.getIpmiPayload();
