...
public class SetSessionPrivilegeLevelResponseTest {
	...
	private static final byte[] WIRE = {
			...
			0x6d, 0x17, 0x2a, 0x40, 0x4b, 0x09, 0x20, 0x1c, 
			(byte) 0xc4, (byte) 0x81, 0x0c, 0x3b, 0x00, 0x04, 0x34
		};
	...
	public void testFromWireData() {
        ...
        SetSessionPrivilegeLevelResponse response = (SetSessionPrivilegeLevelResponse) session.getIpmiPayload();
		...
		assertEquals(RequestedMaximumPrivilegeLevel.ADMINISTRATOR, response.privilegeLevel);
