...
public class ChassisControlRequestHardResetTest {
	...
	private static final byte[] byteSequence = {
			...
			0x20, 0x00, (byte) 0xe0, (byte) 0x81, 0x00, 0x02, 0x03, 0x7a 
			};
	...
	public void testMarshal() throws Exception {
		...
		request.chassisCommand = ChassisControlRequest.ChassisCommand.HardReset;
	...
	public void testUnmarshal() {
        ...
        assertEquals(ChassisControlRequest.ChassisCommand.HardReset, request.chassisCommand);
	}
}
