...
public class ChassisControlRequestPowerUpTest {
	...
	private static final byte[] byteSequence = {
			...
			0x20, 0x00, (byte) 0xe0, (byte) 0x81, 0x00, 0x02, 0x01, 0x7c 
			};
	...
	public void testMarshal() throws Exception {
		...
		request.chassisCommand = ChassisControlRequest.ChassisCommand.PowerUp;
	...
	public void testUnmarshal() {
        ...
        assertEquals(ChassisControlRequest.ChassisCommand.PowerUp, request.chassisCommand);
	}
}
