...
public class ChassisControlResponseTest {
	...
	private static final byte[] byteSequence = {
			...
			0x20, 0x04, (byte) 0xdc, (byte) 0x81, 0x00, 0x02, 0x00, 0x7d, 
			};
	...
	public void testMarshal() throws Exception {
		...
		ChassisControlResponse response = new ChassisControlResponse();
		response.setIpmiCompletionCode((byte) 0);
	...
	public void testUnmarshal() {
        ...
        ChassisControlResponse response = (ChassisControlResponse) session.getIpmiPayload();

        assertEquals(IpmiPayloadType.IPMI, response.getPayloadType());
        
        assertEquals(0x00, response.getIpmiCompletionCode());
	}
}
