...
public class ChassisControlRequestPowerDownTest {
	...
	private static final byte[] byteSequence = {
			...
			0x20, 0x00, (byte) 0xe0, (byte) 0x81, 0x00, 0x02, 0x00, 0x7d 
			};
	...
	public void testMarshal() throws Exception {
		...
		request.chassisCommand = ChassisControlRequest.ChassisCommand.PowerDown;
	...
	public void testUnmarshal() {
        ...
        assertEquals(ChassisControlRequest.ChassisCommand.PowerDown, request.chassisCommand);
