...
public class ChassisControlRequestPowerCycleTest {
	...
	private static final byte[] byteSequence = {
			...
			0x20, 0x00, (byte) 0xe0, (byte) 0x81, 0x00, 0x02, 0x02, 0x7b 
			};
	...
	public void testMarshal() throws Exception {
		...
		request.chassisCommand = ChassisControlRequest.ChassisCommand.PowerCycle;
	...
	public void testUnmarshal() {
        ...
        assertEquals(ChassisControlRequest.ChassisCommand.PowerCycle, request.chassisCommand);
	}
}
