...
public class ChassisControlRequestPulseDiagnosticInterruptTest {
	...
	private static final byte[] byteSequence = {
			...
			0x20, 0x00, (byte) 0xe0, (byte) 0x81, 0x00, 0x02, 0x04, 0x79 
			};
	...
	public void testMarshal() throws Exception {
		...
		request.chassisCommand = ChassisControlRequest.ChassisCommand.PulseDiagnosticInterrupt;
	...
	public void testUnmarshal() {
        ...
        assertEquals(ChassisControlRequest.ChassisCommand.PulseDiagnosticInterrupt, request.chassisCommand);
	}
}
